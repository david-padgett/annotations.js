...
// $$test.assertTrue("SchizophrenicType: annotation is annotated", function() {return $$af.getFrameworkState(SchizophrenicType) != null});
//
// $$test.assertTrue("SchizophrenicType: annotation has 2 annotations", function() {return $$af.getFrameworkState(SchizophrenicType).annotations.length == 2});
// $$test.assertTrue("SchizophrenicType: annotation has TypeAnnotation annotation", function() {return $$af.getFrameworkState(SchizophrenicType).annotations[0].constructor == $$af.systemAnnotationTypes.TypeAnnotation});
// $$test.assertTrue("SchizophrenicType: annotation has MethodAnnotation annotation", function() {return $$af.getFrameworkState(SchizophrenicType).annotations[1].constructor == $$af.systemAnnotationTypes.MethodAnnotation});
